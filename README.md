This was for a course I took. Despite the name, it barely went over physics topics(it briefly went over topography) and instead went over machine learning in a general sense. Predictions, image/data classification and accuracy testing is some of the stuff I remember. The main programing language for this course was MATLAB, which is very similar to Python in my opinion.
